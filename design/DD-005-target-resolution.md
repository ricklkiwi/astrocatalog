...
Fuzzy string matching (edit distance) is used only to *suggest* candidates in the review UI, never to auto-merge — silent mis-merges are worse than manual review.
